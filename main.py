...
# Configure CORS middleware with most permissive settings
app.add_middleware(
    CORSMiddleware,
...
print("✅ CORS middleware configured with permissive settings")
...
@app.options("/travel/search", include_in_schema=False)
async def options_travel_search():
